...
const SwitchModeButton = ({ text }) => {
    ...
    return (
        <label
            ...
            className={`w-auto flex items-center border gap-2 text-sm font-semibold shadow-lg p-2 rounded-xl cursor-pointer select-none transition-colors duration-200 ${vegMode ? "bg-green-200 border-green-600" : "bg-transparent border-gray-300"
